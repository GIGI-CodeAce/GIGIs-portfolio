...
export default function RootLayout({
  ...
  return (
    ...
    <link rel="icon" 
    href="https://github.com/GIGIsOtherStuff/mainWebMedia/blob/main/AppImages/others/mainWebNew.svg?raw=true" type="image/x-icon" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="theme-color" content="#000000" />
    <meta name="description" content="My portfolio website. You can find there anything related to my programming experience. From Dobre Robert." />
    ...
    <meta property="og:description" content="My portfolio website. You can find there anything related to my programming experience. From Dobre Robert." />
    ...
    <meta name="twitter:description" content="My portfolio website. You can find there anything related to my programming experience. From Dobre Robert." />
