    ...
    return(
        ...
        <ul className="socials">
            <a href='https://www.linkedin.com/in/dobre-robert/' target='_blank'>
                <li>LinkedIn <Image className='redirect-icons' width={20} height={20} 
                            loading='lazy' src={linkedInIcon} alt='LinkedIn icon'/></li>
            </a>
            <a href='https://github.com/GIGI-CodeAce' target='_blank'>
                <li>Github <Image className='redirect-icons' width={20} height={20} 
                            loading='lazy' src={githubIcon} alt='Github icon'/></li>
            </a>
        </ul>
            <div>
            <a href='https://mail.google.com/mail/?view=cm&fs=1&to=gigicodeace@gmail.com&su=Inquiry&body=Hello,' target='_blank'>
                <li className='gmail'>gigicodeace@gmail.com<Image className='redirect-icons' 
                    width={20} height={20} loading='lazy' src={gmailIcon} alt='Gmail icon'/></li>
            </a>
            </div>
            </div>
        </footer>
